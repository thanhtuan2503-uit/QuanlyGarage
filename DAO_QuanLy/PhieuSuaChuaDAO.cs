...
namespace DAO_QuanLy
{
    public class PhieuSuaChuaDAO
    {
        ...
        public DataTable ThemHangVTPT(DataTable dt, int a, string VTPT, int Soluong, int DonGia, string MaPhuTung)
        {
        ...
        public DataTable ThemHangTienCong(DataTable dt, int a, string NoiDung, int ChiPhi, string MaTC)
        {
            DataRow dr = dt.NewRow();
            dr["STT"] = a;
            dr["Nội dung"] = NoiDung;
        ...
        public void NhapVTPT(DataTable VTPT)
        {
            string query;
            //int remain = 0;
            int i = 0;
        ...
        public bool KiemTraSoLuong(DataTable VTPTDangNhap, string MaVTPT, int SoLuong)
        {
            string query = "select * from KHO where MaPhuTung = " + MaVTPT;
